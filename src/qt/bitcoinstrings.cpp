...
QT_TRANSLATE_NOOP("groestlcoin-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Block creation options:"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Change index out of range"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Copyright (C) %i-%i"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Done loading"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Error initializing wallet database environment %s!"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Importing..."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Maintain at most <n> connections to peers (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Node relay options:"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Options:"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("groestlcoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Rebuild chain state from the currently indexed blocks"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Set maximum BIP141 block weight (default: %d)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Set the number of threads to service RPC calls (default: %d)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify pid file (default: %s)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify wallet file (within data directory)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Specify your own public address"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Spend unconfirmed change when sending transactions (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("groestlcoin-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("groestlcoin-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("groestlcoin-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("groestlcoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("groestlcoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("groestlcoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Tor control port password (default: empty)"),
...
QT_TRANSLATE_NOOP("groestlcoin-core", "Transaction too large"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("groestlcoin-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("groestlcoin-core", "Unknown network specified in -onlynet: '%s'"),
