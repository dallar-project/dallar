...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dallar-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dallar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dallar transaction") + "\n" +
              "  dallar-tx [options] -create [commands]   " + _("Create hex-encoded dallar transaction") + "\n" +
              "\n";
